...
import com.joaopaulo.cursomc.repositories.ItemPedidoRepository;
import com.joaopaulo.cursomc.repositories.PagamentoRepository;
import com.joaopaulo.cursomc.repositories.PedidoRepository;
import com.joaopaulo.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"JP","jpmfbc@gmail.com","36378912377",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null,"maria silva","joao_max5@hotmail.com","52331211078",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("88769214","33412398"));
		cli2.addPerfis(Perfil.ADMIN);
						
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida vera cruz", "205", null, "centro", "28777519", cli2, c2);
		...
		ItemPedido ip2 = new ItemPedido(ped1, p3, 0.00, 2, 80.000);
		ItemPedido ip3 = new ItemPedido(ped2, p2, 100.00, 1, 800.000);
